...
#              implementation.
#  2023-12-31: Modified the script to work with Python 3.4.3 (Shawn Falconbury).
#
# TODO
#  * add CLI parser
#
...
if __name__ == '__main__':
    tests = [
        ('192.145.143.0', 23, ['192.168.0.1', '192.168.114.128', '10.0.0.1']),
    ...
    for ip, mask, test_ip in tests:
        ...
        print('integer...:', int(net))  # Changed long to int
        print('hex.......:', net.hex())
